 ...
 * */
    ...
    public function getFollowCount($member_id){
        $count = $this->find('count',array('conditions'=>array('Follower.del_flg' => 0 ,
                                            ...
                                            'joins'=>array(
                                                array('table'=>'members',
                                                            'alias'=>'Member',
                                                            'type'=>'LEFT',
                                                            'conditions'=>array('Follower.follow_member_id = Member.id'),
                                                )
                                            )));
    ...
    public function getFollowerCount($member_id){
        $count = $this->find('count',array('conditions'=>array('Follower.del_flg' => 0 ,
                                                              'Follower.follow_member_id' => $member_id,
                                                              'Member.del_flg' => 0,
                                                              'Member.status <' => 3,
                                                            ),
                                            'joins'=>array(
                                                array('table'=>'members',
                                                            'alias'=>'Member',
                                                            'type'=>'LEFT',
                                                            'conditions'=>array('Follower.member_id = Member.id'),
                                                )
                                            )));
